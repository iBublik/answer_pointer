...
(function() {
  var showErrors, showForm;

  showForm = function(objectType) {
    return $(".edit-" + objectType + "-link").click(function(e) {
      var objectId;
      e.preventDefault();
      $(this).hide();
      objectId = $(this).data(objectType + "Id");
      return $(("form#edit-" + objectType + "-") + objectId).show();
    });
  };

  showErrors = function(formSelector, errorHtml) {
    var $errors, $form;
    $form = $(formSelector);
...
(function() {
  $(function() {
    return $('.edit-question-link').click(function(e) {
      ...
      return $('form#edit-question-' + questionId).show();
    });
  });
